...
//
//	//配置平行光源(红色调)
//	ZDirectionLight directionLight(glm::vec4(0.9f, 0.85f, 0.8f, 1.0f), glm::vec3(-0.2f, -1.0f, -0.3f));
...
//
//	//创建着色器
//	Shader myShader1_light("shaders/openGLLearning34/vertexShader_forlight.vs.c", "shaders/openGLLearning34/fragmentShader1_forlight.fs.c");
...
//	Shader myShader1("shaders/openGLLearning34/vertexShader.vs.c", "shaders/openGLLearning34/fragmentShader1.fs.c");
//	Shader myShader1_shadowmap("shaders/openGLLearning34/vertexShader_forshadowdepth.vs.c", "shaders/openGLLearning34/fragmentShader1_forshadowdepth.fs.c");
//	Shader myShader1_sampleRect("shaders/openGLLearning34/vertexShader_forsampleRect.vs.c", "shaders/openGLLearning34/fragmentShader1_forsampleRect.fs.c");
//	
//	//设置采样器对应的纹理单元
//	myShader1.Use();
//	myShader1.SetFloat("material.shininess", 32.0f);
//	//把灯光信息传递给shader
...
//	glm::mat4 perspectiveMM = glm::ortho(-10.0f, 10.0f, -10.0f, 10.0f, 1.0f, 10.0f);
//	//从光源角度的相机视图矩阵(从光的反方向的一个位置看向场景中央)
//	glm::mat4 viewMM = glm::lookAt(-10.0f * directionLight.mLightDirection, glm::vec3(0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
//	myShader1_shadowmap.Use();
//	myShader1_shadowmap.SetMat4f("v_matrix", viewMM);
//	myShader1_shadowmap.SetMat4f("p_matrix", perspectiveMM);
//
//	//生成一个帧缓冲来存储渲染的深度贴图
//	unsigned int shadowDepthMapFBO;
//	glGenFramebuffers(1, &shadowDepthMapFBO);
//	//生成一个2D纹理提供给帧缓冲的深度缓冲使用
//	const GLuint shadowW = 1024, shadowH = 1024;//阴影深度贴图的分辨率
...
//	//int test_width, test_height, test_channelsNum;
//	//unsigned char* test_data = stbi_load("assets/textures/mx.jpg", &test_width, &test_height, &test_channelsNum, 0);
//	//if (test_data) {//写入数据
...
//	//stbi_image_free(test_data);	//生成纹理后释放data内存
//
//	//保持渲染循环
...
//		myShader1_shadowmap.Use();
//		testModel.DrawDepth(&myShader1_shadowmap, glm::mat4(1.0f));
//		glBindFramebuffer(GL_FRAMEBUFFER, 0);
//
//		//渲染场景
...
//
//		//渲染一个方片显示渲染出来的深度贴图
//		myShader1_sampleRect.Use();
//		myShader1_sampleRect.SetMat4f("v_matrix", zcamera.GetCameraViewMatrix());
//		myShader1_sampleRect.SetMat4f("p_matrix", zcamera.GetCameraperspectiveMatrix());
//		myShader1_sampleRect.SetInt("diffTex", 0);
//		glActiveTexture(GL_TEXTURE0);
//		glBindTexture(GL_TEXTURE_2D, depthMap);
//		testModel_showMap.SampleDraw(&myShader1_sampleRect);
//
//		//渲染平行光物体
//		myShader1_light.Use();
