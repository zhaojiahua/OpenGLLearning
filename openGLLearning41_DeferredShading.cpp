...
//
//	//设置四个方片的位置
//	glm::mat4 squareMMs[4] = { glm::mat4(1.0f),glm::mat4(1.0f),glm::mat4(1.0f),glm::mat4(1.0f) };
//	squareMMs[0] = glm::scale(squareMMs[0], glm::vec3(0.2f));
//	squareMMs[0] = glm::translate(squareMMs[0], glm::vec3(-52.0f, 37.0f, 0.0f));
//	squareMMs[1] = glm::scale(squareMMs[1], glm::vec3(0.2f));
//	squareMMs[1] = glm::translate(squareMMs[1], glm::vec3(52.0f, 37.0f, 0.0f));
//	squareMMs[2] = glm::scale(squareMMs[2], glm::vec3(0.2f));
//	squareMMs[2] = glm::translate(squareMMs[2], glm::vec3(-52.0f, -37.0f, 0.0f));
//	squareMMs[3] = glm::scale(squareMMs[3], glm::vec3(0.2f));
//	squareMMs[3] = glm::translate(squareMMs[3], glm::vec3(52.0f, -37.0f, 0.0f));
//
//	//保持渲染循环
...
//		//testModel.SampleDraw(&myShader1);
//
