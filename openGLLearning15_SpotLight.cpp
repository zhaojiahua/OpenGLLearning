...
//
//	//创建顶点着色器
//	Shader myShader1("shaders/openGLLearning15/vertexShader.vs.c", "shaders/openGLLearning15/fragmentShader1.fs.c");
//	
//	//纹理
//	//生成2个纹理对象
...
//	myShader1.SetFloat("light.cutoff", glm::cos(glm::radians(12.5f)));
//	myShader1.SetFloat("light.outercutoff", glm::cos(glm::radians(17.5f)));
//
//	//开启深度测试
...
//		//以相机的位置和方向设置聚光灯
//		myShader1.SetVec3f("light.position", zcamera.cameraPos);
//		myShader1.SetVec3f("light.direction", zcamera.GetCameraFront());
