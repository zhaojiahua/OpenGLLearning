...
vec4 CalculateDirLight(DirLight light,vec3 normal,vec3 viewDir,vec4 reflectColor){
	...
	vec4 tempdiffuse=2*reflectColor+0.1*(tempdiffuse_+texture(material.texture_diffuse1,vertexUV)+texture(material.texture_diffuse2,vertexUV)+texture(material.texture_diffuse3,vertexUV));
