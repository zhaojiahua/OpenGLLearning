...
//
////设置光源的位置和颜色
//glm::vec3 g_lightColor = { 0.95f,0.8f,1.0f };
...
//
//	//创建顶点着色器
//	Shader myShader1("shaders/openGLLearning14/vertexShader.vs.c", "shaders/openGLLearning14/fragmentShader1.fs.c");
...
//	myShader1.SetFloat("light.kc", 1.0f);
//	myShader1.SetFloat("light.kl", 0.09f);
//	myShader1.SetFloat("light.kq", 0.032f);
//
...
//	tempModelMatrix = glm::translate(tempModelMatrix, g_lightPos);
//	tempModelMatrix = glm::scale(tempModelMatrix, glm::vec3(0.2f));
//	glUniformMatrix4fv(glGetUniformLocation(myShader1_L.ID, "m_matrix"), 1, GL_FALSE, glm::value_ptr(tempModelMatrix));
//
//	//开启深度测试
