...
//	//创建顶点着色器
//	Shader myShader1("shaders/openGLLearning19/vertexShader.vs.c", "shaders/openGLLearning19/fragmentShader1.fs.c");
//
//	//设置采样器对应的纹理单元
//	myShader1.Use();
...
//	glm::mat4 tempModel2 = glm::mat4(1.0f);
//	tempModel = glm::scale(tempModel, glm::vec3(0.2f));
//
//	//保持渲染循环
